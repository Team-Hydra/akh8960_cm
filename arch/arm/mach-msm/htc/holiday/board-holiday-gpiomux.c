...
static struct msm_gpiomux_config holiday_gsbi_configs[] __initdata = {
	{
		.gpio      = 44,		
		.settings = {
...
void __init holiday_init_gpiomux(void)
{
	int rc;
	...
	msm_gpiomux_install(holiday_gsbi_configs,
			ARRAY_SIZE(holiday_gsbi_configs));
